...
discord-round-notifications-end = Раунд #{ $id } закончился. Он длился { $hours } ч., { $minutes } мин., and { $seconds } сек.
discord-round-notifications-end-ping = <@&{ $roleId }>, раунд скоро закончится!
